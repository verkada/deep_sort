"""
Inference model from Re-ID FastCNN in DeepSort paper.
Original code: https://github.com/nwojke/deep_sort
Paper: Deep Cosine Metric Learning for Person Re-identification
